<template>
    <div style="padding-top:1.2rem;">
        ...
        <div class="share_code">
            <header class="share_header">加熊Brown微信，获取答案。</header>
            <img src="../images/6-2.jpg" height="212" width="212" class="code_img"> 
        </div>
        ...
        <div style="position:fixed;width:100%;bottom:0;">
                <van-button square size="large" type="info" @click="back">再来一次</van-button>
        </div>
    </div>
</template>
